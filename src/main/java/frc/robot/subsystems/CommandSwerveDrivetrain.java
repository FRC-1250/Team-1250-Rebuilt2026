 ...
 */
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem, MonitoredSubsystem {
    ...
    public void registerWithHealthMonitor(HealthMonitor monitor) {
        ...
        monitor.addComponent("Drivetrain", "Gyro", getPigeon2())
